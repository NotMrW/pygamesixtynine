...
class SpeedyBoi(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        self.sprites = self.spritesheet.get_images(0,0,32,32,4)
        self.image = self.sprites[0]
...
class Bloater(pygame.sprite.Sprite):
    count = 0
    def __init__(self, game):
        """PHATT BOI"""
        super().__init__()
        ...
        #set up its spritesheet
        self.spritesheet = SpriteSheet(r"sprites\machete.png") #SUBJECT TO CHANGE
        self.sprites = self.spritesheet.get_images(0,0,48,48,1) #SUBJECT TO CHANGE
        self.image = self.sprites[0]
        ...
        if player:
            if self.rect.colliderect(player.rect):
                if player.shield > 0:
                    ...
                    player.HP -= 3 #maybe we should add a damage variable?
                self.hp -= 7
...
class Crawler(pygame.sprite.Sprite):
    ...
    def __init__(self, game):
        ...
        #initialize its speedy spritesheet
        self.spritesheet = SpriteSheet(r"sprites\crawler.png")
        self.sprites = self.spritesheet.get_images(0,0,32,32,4)
        self.image = self.sprites[0]
